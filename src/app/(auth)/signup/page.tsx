    ...
    <section className="bg-white">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <Image height={870} width={870} alt="Image"
            src="/expense.avif"
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6 border-2 p-6 border-gray-600 rounded-xl">
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  id="FirstName"
                  name="first_name"
                  className="mt-1 w-full rounded-md border-gray-200 focus:outline-none bg-white text-gray-700 shadow-sm"
                />
              </div>
              <div className="col-span-6 sm:col-span-3">
                <label
